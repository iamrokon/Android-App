...
public class InfoImergencyDetailActivity extends AppCompatActivity {
    ...
    private void loadBackdrop() {
        ...
        for (int i=0;i<DataImergencyInfo.infos.length;i++)                                   //TODO : just change this loop
        {
            DataImergencyInfo infoTmp = DataImergencyInfo.infos[i];
