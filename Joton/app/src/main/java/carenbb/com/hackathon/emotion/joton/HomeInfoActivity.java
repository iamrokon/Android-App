...
public class HomeInfoActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager)
    {
        ...
        adapter.addFragment(new InfoDeasesFragment(), "মায়ের রোগবালাই");
        adapter.addFragment(new InfoChildDeasesFragment(), "শিশুর রোগবালাই");
        adapter.addFragment(new InfoImergencyFragment(), "জরুরী বিষয়াবলী");
